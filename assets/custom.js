...
//   if(d<1){
//     someId.innerHTML = `
//     <div class="announcement_number"><span class="digit">${h}</span><span class="announcement_text">T<span class="hide-small">ime</span></span></div>
...
//   }else{
//     someId.innerHTML = `
// <div class="announcement_number"><span class="digit">${d}</span><span class="announcement_text">
// d<span class="hide-small">age</span></span></div>
// <div class="announcement_number"><span class="digit">${h}</span><span class="announcement_text">T<span class="hide-small">ime</span></span></div>
// <div class="announcement_number"><span class="digit">${m}</span><span class="announcement_text">M<span class="hide-small">inutter</span></span></div>
// <div class="announcement_number"><span class="digit">${s}</span><span class="announcement_text">S<span class="hide-small">ekunder</span></span></div>
// `
